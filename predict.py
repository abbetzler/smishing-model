...
# Prediction endpoint
@app.post("/predict")
async def predict_sms(data: SMSInput, api_key: str = Depends(get_api_key)):
    print(data.message)
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=443, ssl_keyfile="certs/key.pem", ssl_certfile="certs/cert.pem")
